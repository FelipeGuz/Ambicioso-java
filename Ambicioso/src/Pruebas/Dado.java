...
public class Dado extends GPolygon{
	
	public Dado(int dimension, int X, int Y){
		super(0,0);
		addVertex(X,Y);
		addVertex(X+dimension,Y);
		addVertex(X+dimension,Y+dimension);
		addVertex(X,Y+dimension);
	}
